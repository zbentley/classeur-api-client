...
function restOrArrayAndCallback(wrapped) {
    return function() {
        let args = _.toArray(arguments),
            // Assumes the last two are an array and a callback.
            statics = args.splice(0, wrapped.length - 2);
...
module.exports.prototype = _.create(module.exports.prototype, {
    ...
    getFiles: _.partial(restOrArrayAndCallback(multiQuery), 'files/'),
    getFile: _.partial(simpleQuery, 'files/'),
    getFolders: _.partial(restOrArrayAndCallback(multiQuery), 'folders/'),
